...
#define PRE_ACCELEROMETER_CALIBRATION_WAIT 5000
#define PRE_MAGNETOMETER_CALIBRATION_WAIT 2000
#define N_SAMPLES_ACCELEROMETER_AVERAGING 15
#define N_SAMPLES_MAGNETOMETER_AVERAGING 15
